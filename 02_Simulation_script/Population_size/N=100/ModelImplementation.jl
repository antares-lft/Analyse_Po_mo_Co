...
#stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.001_L=1000_Nh=200.csv", Malthusian())
#stationary_distribution(0.5, 1e-6, "WrightianFitnessLandscape_s=0.001_L=1000.csv", Wrightian(200))
stationary_distribution(0.5, 1e-6, "AA_Fitness_Landscape.fl", Wrightian(2e2))



#=
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.0001_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.0005_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.001_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.0025_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_s=0.00125_L=1000_Nh=200.csv")


stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_Uniform_smax=0.0001_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_Uniform_smax=0.0005_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_Uniform_smax=0.001_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_Uniform_smax=0.0025_L=1000_Nh=200.csv")
stationary_distribution(0.5, 1e-6, "ScaledMalthusianFitnessLandscape_Uniform_smax=0.005_L=1000_Nh=200.csv")
